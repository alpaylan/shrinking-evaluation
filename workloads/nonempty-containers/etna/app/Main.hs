...
workloadName :: String
workloadName = "nonempty-containers"
...
runQuickCheck "DeleteMaxNeMapKeysShrink" =
  qcDrive GQ.gen_delete_max_ne_map_keys_shrink GQ.shrink_delete_max_ne_map_keys_shrink P.property_delete_max_ne_map_keys_shrink
runQuickCheck "DeleteMaxNeIntMapKeysShrink" =
  qcDrive GQ.gen_delete_max_ne_int_map_keys_shrink GQ.shrink_delete_max_ne_int_map_keys_shrink P.property_delete_max_ne_int_map_keys_shrink
runQuickCheck "DeleteMaxNeSetShrink" =
  qcDrive GQ.gen_delete_max_ne_set_shrink GQ.shrink_delete_max_ne_set_shrink P.property_delete_max_ne_set_shrink
runQuickCheck "DeleteMaxNeIntSetShrink" =
  qcDrive GQ.gen_delete_max_ne_int_set_shrink GQ.shrink_delete_max_ne_int_set_shrink P.property_delete_max_ne_int_set_shrink
runQuickCheck "IntersperseLengthInvariant" =
  qcDrive GQ.gen_intersperse_length_invariant GQ.shrink_intersperse_length_invariant P.property_intersperse_length_invariant
runQuickCheck "SplitLeftPartitionAtUpperBound" =
  qcDrive GQ.gen_split_left_partition_at_upper_bound GQ.shrink_split_left_partition_at_upper_bound P.property_split_left_partition_at_upper_bound
runQuickCheck "IsSubmapOfReflexiveAndKeyExists" =
  qcDrive GQ.gen_is_submap_of_reflexive_and_key_exists GQ.shrink_is_submap_of_reflexive_and_key_exists P.property_is_submap_of_reflexive_and_key_exists
runQuickCheck "UpdateLookupReturnsOriginal" =
  qcDrive GQ.gen_update_lookup_returns_original GQ.shrink_update_lookup_returns_original P.property_update_lookup_returns_original
